...
public class Broker implements Comparable , Serializable{
     ...
     * @param path path that contains the config file
     * @throws IOException
     */
    private void initBroker(String path) throws IOException {

        // File for setting up the specific broker
        ...
        // writing to the file for the next Broker
    ...
    private void openBrokServer() throws IOException {
        ...
        try {
            while(true) {
                ...
                // reading initial message, each message triggers
                // a specific action
    ...
    /**
     * Makes/updates hashmaps when a publisher matches
     * his info to brokers for the first time
     * @param newAppnode publisher that wants to match his info
     */
    public void makeHashMaps(AppNode newAppnode){
        ...
        // if a hashmap is empty that means all hashmaps are
        if (forUsers.isEmpty()){
    ...
    /**
     * Updates hashmaps after a publisher uploads
     * or deletes a video
     * @param newAppnode appnode that uploaded or deleted a video
     * @param video video that was uploaded or deleted
     * @param message message that was sent (publish or delete)
     */
        ...
        if (message.equals("publish")){
            ...
            for (String hashtag : hashtags){
                if (keySource.containsKey(hashtag)){
                    ...
                    // this appnode is already responsible for this topic
     ...
     * @param newAppnode appNode to be added
     */
    ...
    /**
     * Used for sorting an arraylist that contains broker objects
     * @param o Broker object to be compared
     * @return the remainder of the hash of the two objects
     */
    @Override
